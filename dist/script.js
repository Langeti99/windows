  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postData('./assets/server.php', formData).then(function (res) {
        ...
        return statusMassage.textContent = massage.failure;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  ...
  bindModals('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showMyModal('.popup', 3000);
};
...
var tabs = function tabs(parentSelector, tabsSelector, contentSelector, activeClass) {
  var display = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  console.log('tabs');
  var parent = document.querySelector(parentSelector),
      tabs = document.querySelectorAll(tabsSelector),
      content = document.querySelectorAll(contentSelector); // active = document.querySelector(activeSelector);
